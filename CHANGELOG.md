...
* Moved images and changed to relative links [Alex Bucknall]
* Moved images directory [Alex]
* Fixes for landr [Alex]
* Fixes for Landr updates [Alex]
* Added logo back [Alex]
